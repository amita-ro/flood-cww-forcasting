...
class FloodMap : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        DetailMapPointList = listOf<DetailMapPointViewItem>(
            DetailMapPointViewItem("21 เมษายน 2022", "บางบาล","พระนครศรีอยุธยา", "ไม่ท่วม", "0.6", genShopPoint( 100.46218155035768, 14.40760866722292)),
            DetailMapPointViewItem("21 เมษายน 2022", "เดิมบางนางบวด","สุพรรณบุรี", "ไม่ท่วม", "0.0", genShopPoint(100.08622775383182,14.861787650491328)),
            DetailMapPointViewItem("21 เมษายน 2022", "ไทรน้อย", "นนทบุรี", "ไม่ท่วม", "2.6", genShopPoint(100.31181635567863, 13.978167345634235)),
            DetailMapPointViewItem("21 เมษายน 2022", "แก่งคอย","สระบุรี", "ไม่ท่วม", "", genShopPoint(101.04857283740867,14.565610084101783)),
            DetailMapPointViewItem("21 เมษายน 2022", "บางระจัน", "สิงห์บุรี", "ไม่ท่วม", "", genShopPoint(100.2588728369711, 14.904481213635997)),
            DetailMapPointViewItem("21 เมษายน 2022", "ลำลูกกา","ปทุมธานี", "ไม่ท่วม", "", genShopPoint( 100.78050548771785, 13.981828916387112)),
            DetailMapPointViewItem("21 เมษายน 2022", "ไชโย","อ่างทอง", "ไม่ท่วม", "", genShopPoint(100.47012824682211,14.666108808445815)),
            DetailMapPointViewItem("21 เมษายน 2022", "เมืองอุทัยธานี", "อุทัยธานี", "ไม่ท่วม", "", genShopPoint(100.02455071132277, 15.383812557067252)),
            DetailMapPointViewItem("21 เมษายน 2022", "ท่าวุ้ง", "ลพบุรี", "ไม่ท่วม", "", genShopPoint(100.50696158093409, 14.814994029944755)),
            DetailMapPointViewItem("21 เมษายน 2022", "มโนรมย์", "ชัยนาท", "ไม่ท่วม", "", genShopPoint(100.14774586154141, 15.338852769844944))
